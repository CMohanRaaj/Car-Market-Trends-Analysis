...
**Name:** C MOHAN RAAJ
**AICTE ID:** STU682c0ae6bea981747716838
...
Linear Regression is used to predict the selling price based on selected car features.

### Random Forest Regression

Random Forest Regression is used as a second prediction model and compared with Linear Regression.
...
* `Car_Market_Trends_Analysis_C_Mohan_Raaj.ipynb`
